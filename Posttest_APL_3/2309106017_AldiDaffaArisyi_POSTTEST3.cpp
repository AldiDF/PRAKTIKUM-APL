...
int delete_data(int indeks){
    unsur[indeks - 1] = unsur[indeks];
    singkatan[indeks - 1] = singkatan[indeks];
    proton[indeks - 1] = proton[indeks];
    elektron[indeks - 1] = elektron[indeks];
    neutron[indeks - 1] = neutron[indeks];
    nomor_atom[indeks - 1] = nomor_atom[indeks];
    nomor_massa[indeks - 1] = nomor_massa[indeks];
...
void update_data(int indeks){
    ...
    wujud[indeks - 1] = pilih_wujud_zat(indeks);
...
void menu_create(){
    ...
    wujud[panjang_array] = pilih_wujud_zat(panjang_array);
